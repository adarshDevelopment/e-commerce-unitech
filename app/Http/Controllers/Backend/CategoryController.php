...
class CategoryController extends BackendBaseController
{
    ...
    protected $title;
    protected $base_route = 'backend.parent.category';
    protected $view_path = 'backend.parent.category';
    protected $image_path = 'images'.DIRECTORY_SEPARATOR.'backend' . DIRECTORY_SEPARATOR.'parent'.DIRECTORY_SEPARATOR . 'category'.DIRECTORY_SEPARATOR;
    ...
    public function getSubcategory(Request $request){
        $subcategoryList = Subcategory::where('category_id',$request->catid)->get();
